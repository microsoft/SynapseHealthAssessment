/*
	=================================
	   CCI Meta Data view
	=================================
	This view defines the metadata for the subsequent CCI health queries.

*/
IF OBJECT_ID('v_CCI_MetaData') IS NOT NULL DROP VIEW v_CCI_MetaData
GO

CREATE VIEW v_CCI_MetaData 
AS
SELECT               
